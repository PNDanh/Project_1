...
public class SRM_BanHang extends javax.swing.JFrame {
    ...
    private void tblHoaDonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblHoaDonMouseClicked
        ...
        loadHDCT(iHDCT.getAllByIDHD(HD.getIdHD()));
    ...
    private void tblSanPhamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPhamMouseClicked
        ...
        for (HoaDonChiTiet HDCT : iHDCT.getAll()) {
            if (HDCT.getHoaDon().getIdHD().equals(HD.getIdHD()) && HDCT.getChiTietSanPham().getId().equals(CTSP.getId())) {
                int sl = Integer.parseInt(ipSL) + HDCT.getSlMua();
                iBH.updateHDCT(getFormDataHDCT_UDorDL(HDCT, String.valueOf(sl)));
                loadHDCT(iHDCT.getAllByIDHD(HD.getIdHD()));
                return;
            } else {
    ...
    private BanhangReponse getFormDataCTSP_UD(String ipSL) {
//        return new BanhangReponse(ctsp);
        return null;
    }
    ...
    private BanhangReponse getFormDataHDCT_UDorDL(HoaDonChiTiet HDCT, String ipSL) {
        HoaDon HD = iHD.getAll().get(tblHoaDon.getSelectedRow());
        ChiTietSanPham CTSP = iCTSP.getAll().get(tblSanPham.getSelectedRow());
    ...
    private void loadHDCT(List<HoaDonChiTiet> lstHDCT) {
